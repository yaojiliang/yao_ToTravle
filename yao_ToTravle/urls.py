"""yao_ToTravle URL Configuration
...
from yao_ToTravle.settings import *
import xadmin
...
urlpatterns = [
    ...
    # 旅游页面
    path('scenicspots/', include(('apps.scenicspots.urls', 'apps.scenicspots'),namespace='scenicspots'), name='scenicspots'),

    # 商城相关
    path('shop/', include(('apps.shop.urls', 'apps.shop'),namespace='shop'), name='shop'),

    # 游记相关
    path('diarys/', include(('apps.diarys.urls', 'apps.diarys'),namespace='diarys'), name='diarys'),
    ...
    # 其余操作相关
    path('operation/', include(('apps.operation.urls','apps.operation'),namespace='operation'), name='operation'),

    # 支付相关
    path('pay/', include(('apps.pay.urls', 'apps.pay'),namespace='pay'), name='pay'),
